...
- **Command**: Класс "команды" CQRS реализующий логику изменения данных (создание, обновление, удаление). Например, в БД.
- **Query**: Класс "запроса" CQRS реализующий логику получения данных. Например, из БД.
