...
- Доменная модель и бизнес-логика (Task 2)
- API для работы с персонами и связями (Task 3-5)
- UI и визуализация древа (Task 6)
- Аутентификация и авторизация (Task 7)
...
[План для разработчика](./TaskList/Task1_TaskForDev.md) | [План для тестирования](./TaskList/Task1_TaskForTest.md)
...
[План для разработчика](./TaskList/Task2_TaskForDev.md) | [План для тестирования](./TaskList/Task2_TaskForTest.md)
...
[План для разработчика](./TaskList/Task3_TaskForDev.md) | [План для тестирования](./TaskList/Task3_TaskForTest.md)
...
[План для разработчика](./TaskList/Task4_TaskForDev.md) | [План для тестирования](./TaskList/Task4_TaskForTest.md)
...
[План для разработчика](./TaskList/Task5_TaskForDev.md) | [План для тестирования](./TaskList/Task5_TaskForTest.md)
...
[План для разработчика](./TaskList/Task6_TaskForDev.md) | [План для тестирования](./TaskList/Task6_TaskForTest.md)
