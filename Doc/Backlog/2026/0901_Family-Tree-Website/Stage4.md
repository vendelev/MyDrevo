...
1. Превышение лимитов дискового пространства при загрузке большого количества медиафайлов
2. Загрузка вредоносных файлов (необходима строгая проверка типов и содержимого)
