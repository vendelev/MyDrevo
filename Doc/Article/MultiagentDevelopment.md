...
Команды соответствуют шагам процесса разработки (0-8), описанным в разделе "Pipeline процесса разработки ПО".
...
Создавая папку ".ai" старался абстрагироваться от конкретного инструмента, тк на вкус и цвет все фломастеры разные.  

На примере Claude Code покажу как это скрестить с любым инструментом.
