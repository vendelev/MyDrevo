...
1. Создать "План для тестирования" - /Doc/Issue/{YYYY}/{MM}/{ISSUE_FOLDER}/**Stages/StageX_TaskForTest.md**.
   ...
   Шаблон файла: [StageX_TaskForTest.md](/.ai_ru/agents/Template/StageX_TaskForTest.md) (копируй как основу и адаптируй под задачу).
...
- ✅ Учтены правила [Architecture.md](/.ai_ru/rules/Architecture.md), [CodeHints.md](/.ai_ru/rules/CodeHints.md) и [Testing.md](/.ai_ru/rules/TestingHints.md)
