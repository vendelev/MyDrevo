...
- Workflow при добавлении новой feature в [FeatureWorkflow.md](/.ai_ru/rules/FeatureWorkflow.md)
...
Используй шаблон [TaskSummary.md](/.ai_ru/agents/Template/TaskSummary.md) (копируй как основу и адаптируй)
...
- ✅ Учтены правила [Architecture.md](/.ai_ru/rules/Architecture.md)
