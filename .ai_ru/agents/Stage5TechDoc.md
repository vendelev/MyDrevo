...
- Опишите общую архитектуру модуля в соответствии с [Clean Architecture](/.ai_ru/rules/Architecture.md).
...
#### 2. Описание предметной области ([Domain](/.ai_ru/rules/Architecture.md#domain))
...
#### 3. Описание реализации бизнес-логики ([Application](/.ai_ru/rules/Architecture.md#application))
...
#### 4. Документация API интерфейсов ([Presentation](/.ai_ru/rules/Architecture.md#presentation))
...
#### 5. Интеграция с внешними системами ([Infrastructure](/.ai_ru/rules/Architecture.md#infrastructure))
