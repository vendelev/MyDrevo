...
argument-hint: "<путь к файлу с функциональными требованиями, формат: @/Doc/FeatureList/{YYYY}/{MM}/{FEATURE_FOLDER}/Spec.md>"
---
...
- `prompt`: "На основе функциональных требований из файла $ARGUMENTS
