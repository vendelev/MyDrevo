...
- Архитектура: [Architecture.md](../rules/Architecture.md)
- Процесс добавления фич: [FeatureWorkflow.md](../rules/FeatureWorkflow.md)
- PHP-правила: [CodeHints.md](../rules/CodeHints.md)
