...
- Новые бизнес-требования в [Spec.md](/Doc/FeatureList/{YYYY}/{MM}/{ISSUE_FOLDER}/Spec.md)
- План реализации в [TaskSummary.md](/Doc/FeatureList/{YYYY}/{MM}/{ISSUE_FOLDER}/TaskSummary.md)
