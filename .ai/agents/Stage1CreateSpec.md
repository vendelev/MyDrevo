...
2. Создать папку "/Doc/FeatureList/{YYYY}/{MM}/{ISSUE_FOLDER}", где:
   {YYYY} - текущий год
   {MM} - текущий месяц
...
3. Создать новый файл (/Doc/FeatureList/{YYYY}/{MM}/{ISSUE_FOLDER}/Spec.md) с детальным описанием бизнес-требований (что именно меняется или создается).
...
- Создана папка "/Doc/FeatureList/{YYYY}/{MM}/{ISSUE_FOLDER}" с правильным именованием
