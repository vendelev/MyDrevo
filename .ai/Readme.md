...
**Функция:** [Описание бизнес-требований](/.ai/agents/Stage1CreateFeature.md)
...
Команда: `/ra-feature <номер задачи> <путь к Summary.md эпика> <номер этапа>`

Алгоритм: [ra-feature.md](/.ai/commands/ra-feature.md)
