...
Если задача не большая, то создавать эпик не обязательно.
...
- Тк технический план разбивается на задачи, то Шаги 3-6 повторяются для каждого задачи.
...
Алгоритм: [ra-epic.md](/.ai/commands/ra-create-epic.md)

### Шаг 1. Описание функциональных требований

Команда: `/ra-feature <номер задачи> <путь к EpicSummary.md эпика> <номер этапа>`

Алгоритм: [ra-feature.md](/.ai/commands/ra-create-feature.md)
...
Алгоритм: [ra-test.md](/.ai/commands/ra-php-test-implementation.md)
...
Алгоритм: [ra-tech-doc.md](/.ai/commands/ra-create-tech-doc.md)

### Шаг 8. Создание архитектурной документации

Команда: `/ra-arch-doc <путь к папке задачи>`

Алгоритм: [ra-arch-doc.md](/.ai/commands/ra-create-arch-doc.md)
