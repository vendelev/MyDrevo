...
1. **Первым делом** прочитай файл `Doc/Mode/CodeAutoFix.md`
...
- **НИКОГДА** не запускай инструменты до прочтения Doc/Mode/CodeAutoFix.md
...
1. Прочитать Doc/Mode/CodeAutoFix.md
...
- Если файл Doc/Mode/CodeAutoFix.md не найден — сообщи пользователю
