...
- **NEVER** run markdownlint before reading .ai/agents/Markdownlint.md
...
1. Read .ai/agents/Markdownlint.md
...
- If file .ai/agents/Markdownlint.md is not found — notify the user
