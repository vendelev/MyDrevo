...
- **НИКОГДА** не запускай Rector до прочтения Doc/Mode/Rector.md
...
1. Прочитать Doc/Mode/Rector.md
...
- Если файл Doc/Mode/Rector.md не найден — сообщи пользователю
