...
- **НИКОГДА** не начинай создание плана до прочтения Doc/Mode/Stage2CreatePlanDev.md
- **ВСЕГДА** следуй точной последовательности шагов из документа
- Все ответы на **русском языке**

## Процесс работы

1. Прочитать Doc/Mode/Stage2CreatePlanDev.md
2. Прочитать AGENTS.md для понимания контекста проекта
3. Прочитать Doc/Rule/CodeStyle.md
...
- Если файл Doc/Mode/Stage2CreatePlanDev.md не найден — сообщи пользователю
